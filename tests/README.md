...
A Perl script that traverses a directory hierarchy (such as the skywater-pdk-libs-sky130_fd_sc_hdll repository), finds directories containing Verilog library cell files (.v), and automatically:
